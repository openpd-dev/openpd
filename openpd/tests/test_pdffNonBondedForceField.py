...
class TestPDFFNonBondedForceField:
    ...
    def test_attributes(self):
        ...
        assert isArrayEqual(self.force_field._target_coord, np.linspace(0, self.force_field._cutoff_radius, 1000))
    ...
    def test_getEnergyInterpolate(self):
    ...
    def test_getForceInterpolate(self):
        interval = self.force_field.derivative_width

        force =  (self.force_field.getEnergy(2-interval/2) - self.force_field.getEnergy(2+interval/2)) / interval / angstrom
